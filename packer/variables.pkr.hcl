...
variable "network_external_bridge" {
  type        = string
  description = "The Proxmox network bridge to use for the network interface."
  default     = "vmbr0"
}

variable "network_external_firewall" {
  type        = bool
  description = "The Proxmox network firewall to use for the network interface."
  default     = false
}

variable "network_internal_bridge" {
  type        = string
  description = "The Proxmox network firewall to use for the network interface."
  default     = "vmbr1"
}

variable "network_internal_firewall" {
  type        = bool
  description = "The Proxmox network bridge to use for the network interface."
  default     = false
}
